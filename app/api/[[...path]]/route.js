...
function generateTemplateCareerPath(profile, analysis) {
  const currentGrade = profile.grade || 'III/c';
  const position = profile.position || 'Staff';
  
  return {
    currentPosition: position,
    currentLevel: currentGrade,
    talentBox: analysis?.talentBox || 'Core Player',
    stages: [
      {
        id: 1,
        year: 'Year 1-2',
        position: `Senior ${position}`,
        level: `${currentGrade} → Next level`,
        focus: 'Technical Excellence & Leadership Foundation',
        description: `Strengthen technical expertise in ${position} role and begin developing leadership capabilities`,
        skills: ['Advanced Technical Skills', 'Analytical Thinking', 'Problem Solving', 'Basic Leadership'],
        training: ['Technical Certification', 'Leadership Foundation', 'Project Management Basics'],
        resources: [
          { type: 'Course', name: 'Coursera Professional Certificate', url: 'https://www.coursera.org' },
          { type: 'Platform', name: 'LinkedIn Learning', url: 'https://www.linkedin.com/learning' },
          { type: 'Certification', name: 'Google Career Certificates', url: 'https://grow.google/certificates' }
        ]
      },
      {
        id: 2,
        ...
        level: 'Grade advancement',
        focus: 'Team Leadership & Process Improvement',
        description: 'Lead small teams, manage projects, and optimize departmental processes',
        skills: ['Team Management', 'Strategic Planning', 'Process Optimization', 'Stakeholder Engagement'],
        training: ['Leadership Development Program', 'Agile Management', 'Strategic Thinking Workshop'],
        resources: [
          { type: 'Course', name: 'Harvard ManageMentor', url: 'https://www.harvardbusiness.org' },
          { type: 'Book', name: 'The Five Dysfunctions of a Team', url: 'https://www.tablegroup.com' },
          { type: 'Certification', name: 'Scrum Master Certification', url: 'https://www.scrum.org' }
        ]
      },
      {
        id: 3,
        year: 'Year 5-7',
        position: 'Manager / Senior Expert',
        level: 'Higher grade',
        focus: 'Department Management & Innovation',
        description: 'Manage departments, drive innovation, and contribute to organizational strategy',
        skills: ['Strategic Leadership', 'Innovation Management', 'Budget & Resource Planning', 'Change Management'],
        training: ['Executive Leadership', 'Innovation & Design Thinking', 'Financial Management'],
        resources: [
          { type: 'Program', name: 'Executive Education - MIT', url: 'https://executive.mit.edu' },
          { type: 'Course', name: 'Stanford Innovation', url: 'https://online.stanford.edu' },
          { type: 'Workshop', name: 'IDEO Design Thinking', url: 'https://www.ideou.com' }
        ]
      },
      {
        id: 4,
        year: 'Year 8+',
        position: 'Director / Chief Expert',
        level: 'Senior grade',
        focus: 'Organizational Leadership & Policy',
        description: 'Shape organizational direction, influence policy, and drive transformation',
        skills: ['Strategic Vision', 'Policy Development', 'Organizational Transformation', 'Executive Communication'],
        training: ['Strategic Leadership Certification', 'Public Policy Analysis', 'Organizational Development'],
        resources: [
          { type: 'Program', name: 'Harvard Kennedy School', url: 'https://www.hks.harvard.edu' },
          { type: 'Certification', name: 'Chief Executive Leadership', url: 'https://www.ced.org' },
          { type: 'Platform', name: 'TED Masterclass', url: 'https://www.ted.com/ted-masterclass' }
        ]
      }
    ],
    keyMilestones: [
      `Master core competencies in ${position} within 18 months`,
      'Lead at least 3 significant projects successfully',
      'Obtain relevant professional certification',
      'Build strong stakeholder relationships across departments',
      'Mentor junior staff members (minimum 3)',
      'Contribute to at least 2 organizational improvements'
    ],
    successMetrics: [
      'Consistent performance ratings above 85/100',
      'Successful project delivery rate > 90%',
      'Team satisfaction and engagement score > 80%',
      'Positive 360-degree feedback from peers and supervisors',
      'Demonstrable impact on organizational goals',
      'Active participation in knowledge sharing and innovation'
    ]
  };
}
