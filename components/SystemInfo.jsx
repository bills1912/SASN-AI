...
import { Database, Cpu, Server, Activity, CheckCircle, BookOpen } from 'lucide-react';
import ApplicationDocumentationSimple from './ApplicationDocumentationSimple';
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="system" className="w-full">
        ...
        <TabsContent value="documentation">
          <ApplicationDocumentationSimple />
        </TabsContent>
      </Tabs>
    </div>
  );
